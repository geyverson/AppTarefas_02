// Como o firebase retorna o erro em inglês, então devemos mostrar o correspondente em PT-BR
// Criamos um função que recebe o código e retorna a mensagem de erro traduzida
// Estamos utilizando uma estrutura do javascript chamada switch case
